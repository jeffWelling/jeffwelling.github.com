...
The problem is clear as day, ssh apparently cannot resolve the names that exist in my name server, but using the IP address works.  Whats particularly strange, is that its intermittent.  It will work say, freshly after a reboot, but later on in the day after a couple hours have passed, it stops working. o.0
